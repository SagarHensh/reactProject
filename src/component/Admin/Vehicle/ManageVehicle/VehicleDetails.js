...
import { inputEmptyValidate, inputEntryValidate } from "../../../../services/Validator/Validator";
...
function VehicleDetails() {
  ...
  function onDateChange(e) {
    // consoleLog("date::::", SetScheduleDate(e.target.value));
  ...
  async function onSave() {
    ...
    if (errorCount === 0) {
      ...
      let res = await ApiCall("addVehicle", obj);
      console.log("res data", res);
      if (
        res.success === true &&
        res.status === ErrorCode.ERROR.ERROR_CODE.SUCCESS
      ) {
        toast.success(AlertMessage.MESSAGE.VEHICLE.ADD_SUCCESS);
        window.scrollTo(0, 0);
    ...
    <>
      ...
      <div className="component-wrapper">
        <div className="page-head-section">
          <div className="hd_bk">
            <i className="fa fa-long-arrow-left" aria-hidden="true" onClick={() => goBackList()}></i>
            <strong>
              <span>Dashboard</span>Add Vehicle
            </strong>
          </div>
        </div>
                ...
                <div className="vehicl_file">
                  <div className="edit_file_in">
                    ...
                    <div className="ed_nm">
                      ...
                      <select value={vehicleTypeId} onChange={vehicleTypeChange} >
                        <option></option>
                    ...
                    <div className="ed_nm">
                      <label>Make</label>
                      <select value={makeId} onChange={makeChange}>
                        <option></option>
                        {makeArr.map((obj, key) => (
                    ...
                    <div className="ed_nm">
                      <label>Model</label>
                      <select value={modelId} onChange={modelChange}>
                        <option></option>
                    ...
                    <div className="ed_nm">
                      ...
                      <select value={vehicleOwnerName} onChange={ownerChange}>
                        <option></option>
                    ...
                    <div className="ed_nm">
                      ...
                      <select value={statusId} onChange={statusChange}>
                        <option></option>
